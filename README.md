...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-13 22:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/382a759a-c408-4a6f-8a75-4794b581043a.git
$ cd 382a759a-c408-4a6f-8a75-4794b581043a
```
